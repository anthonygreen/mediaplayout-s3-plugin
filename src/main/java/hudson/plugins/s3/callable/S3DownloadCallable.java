...
public final class S3DownloadCallable extends S3Callable<String>
{
    ...
    public S3DownloadCallable(String accessKey, Secret secretKey, Secret sessionToken, boolean useRole, Destination dest, String region, ProxyConfiguration proxy)
    {
        super(accessKey, secretKey, sessionToken, useRole, region, proxy);
        this.dest = dest;
    }
